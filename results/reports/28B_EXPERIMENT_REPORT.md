...
| 105B (paper) | ~840 GB | 3.1s | 6.8s | 2.2× |
...
105B:  transfer ~8.4s / total ~6.8s  → 2.2× (transfer > compute)
```
...
- Trend extrapolates to paper's 2.2× at 105B
...
| Low MFU (6.3%) | Short sequence (1024 tokens) → low arithmetic intensity | Not representative of paper's 61% |

---

## Comparison Summary

| Metric | 28.4B (Ours) | 105B (Paper) | Ratio |
|--------|-------------|--------------|-------|
| Parameters | 28.4B | 105B | 27% |
| Layers | 48 | 48 | 100% |
| Hidden | 6144 | 8192 | 75% |
| Async speedup | **1.50×** | 2.2× | 68% |
| GPU memory | 25.5 GB | 115 GB | 22% |
