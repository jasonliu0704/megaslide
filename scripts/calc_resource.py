#!/usr/bin/env python3
"""
MegaSlide-DiT Resource Calculator
...
def mode_cpu_memory():
    ...
    print(f"  Rule: MegaSlide-DiT needs ~12x model BF16 size in CPU RAM")
...
def main():
    print()
    print("  ╔══════════════════════════════════════════════════╗")
    print("  ║       MegaSlide-DiT Resource Calculator           ║")
