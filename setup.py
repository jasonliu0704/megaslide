"""Setup script for MegaSlide-DiT: Memory-Centric Video Diffusion Adaptation."""
...
setup(
    ...
    version="0.3.0",
    author="Jason Liu",
    description="MegaSlide-DiT: Memory-Centric Adaptation and Deformable Local Attention for Efficient Video Diffusion",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/jasonliu2050/megaslide",
    ...
    keywords="deep-learning, video-diffusion, dit, deformable-attention, cpu-offloading, megaslide",
)
