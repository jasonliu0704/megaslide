...
> **Historical review (2026-05-08), corrected.** The "Expected Performance" table
> below copied unrun 105B targets ("3.1s / 61% MFU / 18 GB"). Those were never
> measured. Measured results (H100 NVL): MFU 4–9.5% (PCIe transfer-bound); async
> 1.25–1.50×; per-step transfer ~100–263 GB on the 12.6–33.3B ladder. See paper
> Section 9 and [`results/RECONCILIATION.md`](results/RECONCILIATION.md).

**Reviewer:** Claude  
**Date:** 2026-05-08  
**Status:** ✅ APPROVED with minor notes (perf targets superseded — see banner)
...
Measured on the H100 NVL (paper Section 9 — replaces the old 105B targets):

| Metric | Measured (12.6–33.3B) | How to Verify |
|--------|----------|---------------|
...
### Performance: later measured on H100 NVL
- MFU is PCIe transfer-bound at 4–9.5% (not the old 61% target); see paper Section 9
- Architecture validated to 33.3B on a single 94 GB GPU
