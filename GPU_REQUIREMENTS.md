...
# GPU Memory Breakdown (Paper Table 2)
...
- Dense OOMs at high frame counts ✅
- Swin scales to 256 frames ✅
- MegaSlide scales to 256 frames ✅
- Learned offsets improve temporal consistency ✅
- Async streaming provides 2× speedup ✅

---

### Goal 4: Exact Paper Reproduction ⚠️
**GPU:** NVIDIA H200 (141 GB)
**Config:** Full (105B params, 256 frames, 1080p)
**Time:** 20-40 hours (5K training steps + VBench eval)
**Cost:** $30-40K (H200 purchase) or $5-10/hour (cloud when available)

**What you can validate:**
- Exact VBench scores from paper
- Exact memory usage (115 GB GPU, 1.47 TB CPU)
- Exact MFU (61% with async)
- Full ablation studies at paper scale
