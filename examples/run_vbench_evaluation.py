...
def main():
    ...
    print("Model          | VBench-Align | VBench-Consist | Frames")
    print("---------------|--------------|----------------|-------")
    print("Dense 3D-DiT   | 0.78 ± 0.02  | 0.85 ± 0.03    | 64")
    print("Swin-DiT       | 0.81 ± 0.02  | 0.79 ± 0.03    | 256")
    print("MegaSlide-DiT  | 0.83 ± 0.02  | 0.88 ± 0.02    | 256")
